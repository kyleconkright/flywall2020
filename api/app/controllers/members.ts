...
export async function getMembers(request: Request, response: Response) {
  try {  
    const result = await axios.get(propublica.members('senate'), propublica.headers);
...
export async function getMember(request: Request, response: Response) {
  try {  
    const result = await axios.get(propublica.member(request.params.memberId), propublica.headers);
    response.json({ data: result.data.results })
  } catch(err) {
    response.json({err});
  }
...
export async function getMemberVotes(request: Request, response: Response) {
  try {  
    const result = await axios.get(propublica.memberVotes(request.params.memberId), propublica.headers);
    response.json({ data: result.data.results })
  } catch(err) {
    response.json({err});
  }
